...
// Split full name: "James Errol V. Viloria" → First=James Errol, Mid=V., Last=Viloria
// Also handles "LASTNAME, Firstname Middle" format
...
<head>
<meta charset="UTF-8">
<title>Application for Leave | NTC JO</title>
...
@media print {
  ...
  /* Remove sidebar spacing when printing */
  .main {
    margin: 0 !important;
    padding: 0 !important;
  }
...
.leave-top-bar button.secondary {
  background: #fff;
  color: #001f3f;
}
.leave-top-bar button.secondary:hover { background: #f0f4f8; }
.leave-top-bar button.active-preview {
  background: #e8a000;
  border-color: #e8a000;
}
...
/* Remove dividing line between 7C/7D and Authorized Officer rows */
#leaveForm > table:last-of-type tr:nth-last-child(1) td {
...
.leave-page.preview-mode input[type="date"] {
  display: none !important;
}
...
/* Override inline display:none for 7B officer preview spans */
...
.leave-page.preview-mode .cb-row input[type="checkbox"]:not(:checked) {
  opacity: 0.2;
}
...
body.dark .leave-page .form-meta {
  color: #000000 !important;
}
    ...
    <table style="margin-top:6px;">
      ...
      <tr>
        ...
        <td style="width:55%;vertical-align:top;padding:6px 8px;">
          ...
          <!-- Static authorized officer — never editable -->
          <div style="margin-top:40px; text-align:center;">
            <div style="border-top:1px solid #000; padding-top:4px;">
              <div style="font-size:11px;">FLORA R. RALAR<br>
      ...
      <!-- 7C + 7D + Authorized Officer — ALL inside one single cell, zero internal borders -->
      <tr>
        <td colspan="2" style="padding:0; border:1px solid #000;">
          <table style="width:100%; border-collapse:collapse; border:none;">
            ...
            <!-- Authorized Officer: same nested table, no border above -->
            <tr>

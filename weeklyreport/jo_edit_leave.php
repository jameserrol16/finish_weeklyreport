...
if (!$id) { header("Location: jo_vreport.php"); exit; }
...
if (!$leave) { header("Location: jo_vreport.php"); exit; }
...
<div id="main" class="main">
  <div class="leave-top-bar">
    <button class="secondary" onclick="window.location='jo_vreport.php'">← Back</button>
  ...
  <form id="editLeaveForm" method="POST" action="jo_edit_leave.php?id=<?= $id ?>" style="display:none;">
